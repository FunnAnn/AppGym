...
class AtGymPlanScreen extends StatefulWidget {
  final String? goal;
  final String? image;
  const AtGymPlanScreen({super.key, this.goal, this.image});

  @override
  State<AtGymPlanScreen> createState() => _AtGymPlanScreenState();
}

class _AtGymPlanScreenState extends State<AtGymPlanScreen> {
  late Future<List<Data>> _futurePlans;

  @override
  void initState() {
    super.initState();
    _futurePlans = PlanService.fetchAtGymPlans();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.goal ?? 'AT GYM Workout Plans',
      ...
      body: FutureBuilder<List<Data>>(
        ...
        builder: (context, snapshot) {
          ...
          if (filteredPlans.isEmpty) {
            return const Center(child: Text('No AT GYM plans found.'));
          }
          // Group by dayNumber
            ...
            children: [
              ClipRRect(
                ...
                child: Stack(
                  children: [
                    Image.asset(
                      widget.image ?? 'assets/images/gym.png',
                      height: 140,
