    ...
    setState(() {
      _filteredList = _packages.where((package) {
        final packageMatch = _packageFilter.isEmpty ||
            package.packageName?.toLowerCase().contains(_packageFilter.toLowerCase()) == true;
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            // Header với số thứ tự và view action
            Row(
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              _buildDetailRow(Icons.label, 'Package Name', package.packageName ?? 'N/A'),
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text(
                'Showing ${_filteredList.length} of ${_packages.length} packages',
                style: TextStyle(
                  color: Colors.grey[600],
                  fontSize: 13,
                  fontWeight: FontWeight.w500,
